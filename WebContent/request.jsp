...
<title>HitchikeRU - Request Registration</title>    
...
<body>
    ...
    <table border="0">
        <thead>
            ...
            <tr>
                <th>Enter Request Information</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>	
					<p></p>	
                    <form method="post" action="SRegisterRequest">
                    <input type="hidden" name="useremail" value=<%= email %> />
                    	<strong>Time of departure:</strong>
                    	<input type="text" name="date10" value="">
                    	 <p></p>
                    	<strong>Give or take how many minutes?(# only):</strong>
                    	<input type="text" name="deviation" size="25">
						...
						<p></p>
                        <strong>Request name(for your reference)</strong>
                        <input type="text" name="requestname" size="25">
                        <p></p>
                        <input type="hidden" name="useremail" value=<%= email %> />
